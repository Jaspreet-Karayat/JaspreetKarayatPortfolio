...
const Header = () => {
    ...
    return (
        <>
            <header className="bg-gradient-to-r from-gray-700 via-gray-900 to-black text-white py-6 px-6 md:px-20 flex justify-between items-center fixed top-0 w-full z-50  border-b-[1px] border-slate-700">
                {/* Logo */}
            ...
            {isMobileMenuOpen && (
                <div className="absolute inset-0 bg-black bg-opacity-50 backdrop-blur-sm z-40">
                    <nav id="mobile-menu" className="absolute top-16 left-0 w-full bg-gradient-to-r from-gray-700 via-gray-900 to-black text-white py-6 px-6 flex flex-col items-center justify-center space-y-6">
                        <Link
                            to="/"
