...
const HomePage = () => {
    ...
    useEffect(() => {
        const fetchHomeData = async () => {
            try {
                ...
                const response = await axios.get('http://localhost:3030/api/home/previewHome', {
                    headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        if (isHomeDataValid && isImageValid) {
            ...
            try {
                const token = JSON.parse(localStorage.getItem('token'));
                const response = await axios.post('http://localhost:3030/api/home/updateHome', formData, {
                    headers: {
